          ...
          <Row>
            <Col lg='6'>
              <div className="hero__content">
                ...
                <h1>Life is short and the world is  <span
                  className="highlight">wide</span>
                </h1>
                <p>
            ...
            <Col lg='2'>
              <div className="hero__img-box hero__video-box mt-4">
                <video src={ heroVideo } loop autoPlay muted alt='' controls  />
              </div>
            </Col>
            <Col lg='2'>
          ...
          <Row>
            <Col lg='6'>
              <div className="experience_content">
                ...
                <p>We recommend destinations and make arrangements for the
                  <br />hotel accommodations, car rentals, transportation, and tours <br/>for customers.
                 </p>
              </div>
